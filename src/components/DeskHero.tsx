...
const PAGES: Record<string, TermPage> = {
  ...
  edu_lectures: {
    ...
    lines: [
      ...
      "━━━━━━━━━━━━━━━━━━━━━━━━",
      "",
      "Invited talks and oral",
      "presentations at domestic &",
      "international conferences.",
      "",
    ],
    subPages: [
      { label: "Invited Talks", pageKey: "lectures_invited" },
      { label: "Oral Presentations", pageKey: "lectures_oral" },
    ],
  },
  lectures_invited: {
    command: "cat education/invited-talks.md",
    lines: [
      "",
      "# Invited Talks",
      "━━━━━━━━━━━━━━━━",
      "",
      "── 2024 ──────────────────",
      "Dec  Neurospine Symposium",
      "  AI Tools for Spinal Imaging",
      "  and Diagnosis",
      "Dec  World MISS 2024",
      "  Developmental Status of Spinal",
      "  Endoscopic Tools",
      "Dec  Chonnam CDW Symposium",
      "  DL Applications in Spinal",
      "  Diagnostics",
      "Oct  Pain Research Society",
      "  Latest Surgical Insights for",
      "  Lumbar Spinal Pain: PELD,",
      "  UBE, Endofusion",
      "Oct  Community Health Lecture",
      "  Management of Degenerative",
      "  Spinal Diseases",
      "Sep  Neurotrauma Symposium",
      "  Managing Chronic Non-Cancer",
      "  Pain in the Elderly",
      "Apr  Vietnam ESS Symposium",
      "  Intro to UBE Surgery -",
      "  Pearls and Pitfalls",
      "Mar  KOSESS-KSNS Joint Symp",
  ...
  lectures_oral: {
    command: "cat education/oral-presentations.md",
    lines: [
      "",
      "# Oral Presentations",
      "━━━━━━━━━━━━━━━━━━━━",
      ...
      "  Schwannoma at C1-2",
      "Oct  KOMISS-KOSESS Summit",
      "  Delayed Spinous Process Fx",
      "  After Endoscopic ULBD",
      "Jul  KASS 2024 · Park City, UT",
      ...
      "── 2023 ──────────────────",
      "Aug  ISASS AP 2023",
      "  ERAS Protocol in Spinal",
      "  Surgery: Tumors vs Degenerative",
      "Jul  Adult Deformity Symposium",
      "  Kyphotic Deformity After TL Fx",
      "  in Severe Osteoporotic Patient",
      "Jul  KNDCRS-Basic Science Joint",
      "  Lumbar Surgery Trends During",
      "  COVID-19 in NHIS",
      "",
      "── 2022 ──────────────────",
      "Nov  CSRS 50th · San Diego, CA",
      "  Reduced Tethering of Nerve",
      "  Root May Reduce C5 Palsy",
      "  in Cervical Laminoplasty",
      "Sep  ASIA Spine 2022",
      "  Comprehensive ERAS in Spine:",
      "  19-Year Single-Center Outcomes",
      "Aug  NS-OS Tumor Joint",
      "  AESOP Syndrome with Multiple",
      "  Myeloma at Lumbar Spine",
      "Jun  Cervical Spine Society",
      "  Additional Surgery Rate After",
      "  Cervical Spine Surgery",
      "Jun  KNDCRS",
      "  Additional Surgery Rate After",
      "  Cervical Spine Surgery",
      "Apr  KNS Spring Meeting",
      "  Intra-Thoracic Paraspinal",
      "  Tumor Surgery Using VATS",
      "Mar  KSNS Spring",
      "  Long-Term Outcomes of Fusion",
      "  for Atlantoaxial Instability",
      "Feb  Cervical Spine Case Review",
