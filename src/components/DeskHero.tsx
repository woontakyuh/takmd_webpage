...
const PAGES: Record<string, TermPage> = {
  ...
  research_ai: {
    ...
    lines: [
      ...
      "━━━━━━━━━━━━━━━━━━━━━",
      "",
      "SpineAlign AI – Auto alignment from X-rays",
      "Fracture Detection – DL vertebral fx dx",
      "Surgery Dashboard – 1,830+ case analytics",
      "",
    ],
  },
  research_pubs: {
  ...
  edu_courses: {
    ...
    lines: [
      ...
      "━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
      "",
      "2024.11 AO Spine Advanced – Complex Cervical & Thoracolumbar",
      "2024.01 Cadaver Workshop – Adult Deformity Advanced Course",
      "2023.05 AO Spine Advanced Cadaver – Cervical & Thoracolumbar",
      "2023.02 Medtronic Memphis – Korean Fundamentals Course",
      "2022.11 Depuy-Synthes Cadaveric – PCF & MIS TLIF Course",
      "",
    ],
  },
  edu_outreach: {
    ...
    lines: [
      ...
      "━━━━━━━━━━━━━━━━━━━━━━━━━━",
      "",
      "2024.02 Dominican Republic – Pediatric spinal deformity surgery mission",
      "  with WSO (World Spine Outreach) Foundation",
      "",
    ],
  },
  ...
  talks_2024: {
    ...
    lines: [
      ...
      "",
      "── Invited Lectures ──────",
      "12.28 Neurospine Symposium – AI Tools for Spinal Imaging and Diagnosis",
      "12.08 World MISS 2024 – Developmental Status of Spinal Endoscopic Tools",
      "12.04 Chonnam CDW Symposium – DL Applications in Spinal Diagnostics",
      "10.13 Pain Research Society – Surgical Insights: PELD, UBE, Endofusion",
      "10.11 Community Health Lecture – Management of Degenerative Spinal Diseases",
      "09.27 Neurotrauma Symposium – Managing CNCP in the Elderly",
      "04.26 Vietnam ESS Symposium – Intro to UBE Surgery: Pearls and Pitfalls",
      "03.23 KOSESS-KSNS Joint – Endoscopic Surgery in Infectious Spondylodiscitis",
      "",
      "── Oral Presentations ────",
      "11.23 KOSASS – UBE Removal of Cervical Schwannoma at C1-2",
      "10.12 KOMISS-KOSESS Summit – Delayed Spinous Process Fx After Endo ULBD",
      "07.11 KASS, Park City UT – DL-Assisted Thoracolumbar Fx Measurement",
      "04.06 WUBES 2024 – Intraoperative Indigo Carmine in UBE",
      "03.22 KOSASS Case Conf – DL-Assisted Thoracolumbar Fx Measurement",
      "",
    ],
  },
  talks_2023: {
    ...
    lines: [
      ...
      "",
      "── Invited Lectures ──────",
      "12.02 5th Biospine – DL System for Vertebral Compression Measurement",
      "09.09 15th IANR Korea – Lumbar Surgery Trends During COVID-19",
      "",
      "── Oral Presentations ────",
      "08.16 ISASS AP 2023 – ERAS Protocol: Tumors vs Degenerative Diseases",
      "07.15 Adult Deformity Symp – Kyphotic Deformity After TL Fx in Osteoporosis",
      "07.10 KNDCRS-Basic Science – Lumbar Surgery Trends During COVID-19 in NHIS",
      "",
    ],
  },
  talks_2022: {
    ...
    lines: [
      ...
      "━━━━━━━━━━━━━━━━━━━━━━━━━",
      "",
      "11.16 CSRS 50th, San Diego – Nerve Root Tethering & C5 Palsy in Laminoplasty",
      "09.22 ASIA Spine 2022 – Comprehensive ERAS: 19-Year Single-Center Outcomes",
      "08.27 NS-OS Tumor Joint – AESOP Syndrome with Myeloma at Lumbar Spine",
      "06.18 Cervical Spine Society – Additional Surgery Rate After Cervical Surgery",
      "06.11 KNDCRS – Additional Surgery Rate After Cervical Surgery",
      "04.23 KNS Spring – Intra-Thoracic Paraspinal Tumor Surgery Using VATS",
      "03.11 KSNS Spring – Fusion Outcomes for Atlantoaxial Instability",
      "02.26 Cervical Case Review – Cervical Kyphosis After C1-2 Schwannoma Removal",
      "",
    ],
  },
};
