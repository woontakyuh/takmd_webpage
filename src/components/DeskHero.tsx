...
const PAGES: Record<string, TermPage> = {
  ...
  tumor_pubs: {
    ...
    lines: [
      ...
      "1st & Co-1st Author:",
      "",
      " 1. Spinal Cord Oligodendroglioma",
      "    Korean J Spine 2015",
      " 2. Subependymoma Surgery",
      "    J Korean Neurosurg Soc 2018",
      " 3. Hemangioblastoma Resection",
      "    Oper Neurosurg 2022",
      " 4. Embolization Timing, Spinal Mets",
      "    J Korean Neurosurg Soc 2023",
      " 5. ERAS in Primary Spinal Tumors",
      "    J Neurosurg Spine 2023",
      "",
      "Co-Author:",
      "",
      " 6. En Bloc Spondylectomy Failure",
      "    Neurospine 2022",
      " 7. MRI in Spinal Cord Tumors",
      "    Sci Rep 2022",
      " 8. C1-C2 Epidural Schwannomas",
      "    Acta Neurochir 2023",
      " 9. Schwannoma Classification MRI",
      "    Neurospine 2024",
      "",
    ],
    links: [
      { label: "#1 →", url: "https://doi.org/10.14245/kjs.2015.12.3.160" },
      { label: "#2 →", url: "https://doi.org/10.3340/jkns.2017.0405.001" },
      { label: "#3 →", url: "https://doi.org/10.1227/ons.0000000000000389" },
      { label: "#4 →", url: "https://doi.org/10.3340/jkns.2022.0204" },
      { label: "#5 →", url: "https://doi.org/10.3171/2023.10.Spine23512" },
      { label: "#6 →", url: "https://doi.org/10.14245/ns.2244092.046" },
      { label: "#7 →", url: "https://doi.org/10.1038/s41598-022-13881-z" },
      { label: "#8 →", url: "https://doi.org/10.1007/s00701-023-05707-2" },
      { label: "#9 →", url: "https://doi.org/10.14245/ns.2448468.234" },
    ],
  },
