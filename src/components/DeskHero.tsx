...
const PAGES: Record<string, TermPage> = {
  ...
  personal_vibe: {
    ...
    lines: [
      ...
      "━━━━━━━━━━━━━",
      "",
      "Building my own domain from scratch",
      "with AI-agent augmented workflow.",
      "",
      "Projects:",
      "  ├─ takmd.com (this site)",
      "  ├─ Surgery Statistics Dashboard",
      "  ├─ Spinoscopy multi-agent dashboard",
      "  ├─ SpineAlign AI",
  ...
  personal_etc: {
    ...
    lines: [
      ...
      "━━━━━━",
      "",
      "Surfing · 9'6\" Beacon, Bing Surfboards",
      "Snowboarding · F2, GS",
      "Car · Model 3 Highland, Tesla",
      "Crypto",
      "",
    ],
  },
