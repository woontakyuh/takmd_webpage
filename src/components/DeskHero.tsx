...
const MARKERS: Marker[] = [
  ...
  { id: "schedule",  label: "Presentations", x: 21, y: 49,  color: "#fb923c", rgb: "251,146,60"  }, // calendar centre
  { id: "myself",    label: "About Me",   x: 35,   y: 63,  color: "#60a5fa", rgb: "96,165,250"  }, // mac mini body
  { id: "research",  label: "Research",   x: 53,   y: 66,  color: "#fbbf24", rgb: "251,191,36"  }, // leather notebook centre
