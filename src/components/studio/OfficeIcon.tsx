type IconName = 'play' | 'pause' | 'volume' | 'muted' | 'arrange' | 'room' | 'overview' | 'clock' | 'sun' | 'moon' | 'spine' | 'research' | 'education' | 'workshop' | 'social' | 'cv' | 'ai' | 'projects' | 'family' | 'bjj' | 'surfing' | 'expand' | 'collapse' | 'close' | 'rotateLeft' | 'rotateRight';
