...
export const PERSONAL_BOOKS = [
  { id: 'rhoton', title: 'Rhoton: Cranial Anatomy and Surgical Approaches', author: 'Albert L. Rhoton, Jr.',
    width: .227, height: .31, thickness: .028, binding: '#aeb8bb',
...
const BOOK_BY_ID = {
  'benzel-1': PERSONAL_BOOKS[1], 'benzel-2': PERSONAL_BOOKS[2], emory: PERSONAL_BOOKS[3],
  csrs: PERSONAL_BOOKS[4], consciousness: PERSONAL_BOOKS[5], memoir: PERSONAL_BOOKS[6], woodpecker: PERSONAL_BOOKS[7], rhoton: PERSONAL_BOOKS[0],
