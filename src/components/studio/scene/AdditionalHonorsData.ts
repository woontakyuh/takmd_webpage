...
export const ADDITIONAL_DOCUMENTS = [
  ...
  {
    frame: { id: 'wcmisst-speaker-2026', name: 'WCMISST 2026 invited speaker certificate', texture: `${ART}wcmisst-speaker-2026.webp?v=surface-20260913`, ...landscape, position: [1.67, 2.26, 3.12] },
  ...
  {
    frame: { id: 'tsess-instructor-2026', name: 'TSESS 2026 workshop instructor certificate', texture: `${ART}tsess-instructor-2026.webp?v=surface-20260913`, ...landscape, position: [2.08, 2.26, 3.12] },
