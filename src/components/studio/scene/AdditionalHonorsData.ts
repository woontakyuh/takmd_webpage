...
export const ADDITIONAL_DOCUMENTS = [
  {
    frame: { id: 'neurospine-reviewer-2025', name: 'Neurospine outstanding reviewer certificate', texture: `${ART}neurospine-reviewer-2025.webp?v=surface-20260913`, ...landscape, position: [-2.18, 2.4, 3.12] },
  ...
  {
    frame: { id: 'kosess-academic-2025', name: 'KOSESS 2025 academic award certificate', texture: `${ART}kosess-academic-2025.webp?v=surface-20260913`, ...portrait, position: [-1.83, 2.4, 3.12] },
  ...
  {
    frame: { id: 'wcmisst-speaker-2026', name: 'WCMISST 2026 invited speaker certificate', texture: `${ART}wcmisst-speaker-2026.webp?v=surface-20260913`, ...landscape, position: [1.67, 2.4, 3.12] },
    item: { id: 'certificate-wcmisst', collection: 'certificates', label: 'Invited speaker', title: '8th World Congress of Minimally Invasive Spine Surgery and Techniques', date: 'May 7–9, 2026', description: 'Presented in recognition of contributions as an invited speaker at WCMISST 2026.', center: [1.67, 2.515, 3.12], copy: 'right' },
  },
  {
    frame: { id: 'tsess-instructor-2026', name: 'TSESS 2026 workshop instructor certificate', texture: `${ART}tsess-instructor-2026.webp?v=surface-20260913`, ...landscape, position: [2.08, 2.4, 3.12] },
    item: { id: 'certificate-tsess', collection: 'certificates', label: 'Workshop instructor', title: 'Taiwan Society of Endoscopic Spine Surgery', date: 'June 9, 2026', description: 'Recognized as an instructor for the 2026 TSESS Simulative Surgery Workshop, Advanced Courses.', center: [2.08, 2.515, 3.12], copy: 'left' },
  },
