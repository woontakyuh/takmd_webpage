...
export function SigneFloor({ power, palette }: { readonly power: number; readonly palette: RoomLightPalette }) {
  ...
  return <group name="Philips Hue Signe gradient floor black" position={[-2.49, 0.0185, 2.84]} rotation={[0, -Math.PI / 4, 0]}>
    <mesh position={[0, 0.11, 0]} castShadow receiveShadow><cylinderGeometry args={[0.0555, 0.0555, 0.22, 48]} /><meshStandardMaterial color="#282b27" metalness={0.6} roughness={0.38} /></mesh>
