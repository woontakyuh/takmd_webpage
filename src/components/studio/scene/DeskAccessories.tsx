...
export function DeskAccessories({ familyPhotoSrc, selected, onSelect, reducedMotion, onClaudeSticker, halo, onHaloControls, roomControlPanel }: Pick<StudioSceneProps, 'familyPhotoSrc' | 'selected' | 'onSelect' | 'onClaudeSticker' | 'reducedMotion' | 'halo' | 'onHaloControls' | 'roomControlPanel'>) {
  return (
    <group>
      ...
      <ScreenBarHalo2Dial position={[ROOM.macMini.position[0] + 0.13, DESK_TOP, ROOM.macMini.position[2]]} halo={halo} onHaloControls={onHaloControls} roomControlPanel={roomControlPanel} />
