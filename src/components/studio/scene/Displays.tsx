    ...
    <group>
      ...
      <Interactive id="education" selected={selected} onSelect={onSelect} reducedMotion={reducedMotion} position={ROOM.gallery.position} rotation={ROOM.gallery.rotation}
        ...
        <group name={WALL_TV.model}>
          ...
          {focusedScreen === 'education' && <TvScreenReader active hovered={tvHovered} talk={talk} slide={collection.talkSlide}
            presentations={presentations} onTalk={onTalk} onSlide={onTalkSlide} onClose={onClose} />}
