...
export const workshopSessions = [
  ...
  },
  {
    ...
    date: '2025-12-20',
    status: 'held',
    title: 'The 5th Endoscopic Spine Surgery — 1st Animal Lab Workshop for Beginners — based on anatomy and pathologies',
    ...
    handsOn: { format: 'Live porcine model, two stations, capped at seven trainees', groups: 2, durationMin: 180 },
    trainees: {
      count: 8,
  ...
  },
  {
    ...
    date: '2026-08-08',
    status: 'held',
    title: 'The 7th Endoscopic Spine Surgery — 2nd Animal Lab Workshop for Beginners',
    titleKo: '제7회 척추 내시경 동물 실습 워크샵 (2회차)',
    venue: HLB_LAB,
    host: ['Hallym University Dongtan Sacred Heart Hospital'],
    ...
    handsOn: { format: 'Live porcine model — morning and afternoon sections, two groups, two faculty per group', groups: 2, sessions: 2, durationMin: 300 },
    certification: true,
    sources: ['Official programme docx', 'Event poster', 'Attendee badge set'],
  },
  {
    ...
    date: '2026-12-20',
    status: 'planned',
    title: 'The 8th Endoscopic Spine Surgery — 1st Cadaver Workshop for Beginners',
    titleKo: '제8회 서울성모 카데바 워크샵',
    venue: {
      name: "Seoul St. Mary's Hospital — Catholic International Bioskills Education Center (CIBEC)",
      nameKo: '서울성모병원 · 가톨릭대학교 국제술기교육센터',
      city: 'Seoul',
    },
    host: ['Hallym University Dongtan Sacred Heart Hospital'],
    audience: 'Beginner spine surgeons who completed the dummy or animal stage',
    role: 'faculty',
    sources: ['Organiser announcement 2026-06-18 (moved from 12-19 Sat to 12-20 Sun)'],
  },
