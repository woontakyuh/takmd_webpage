...
Display the owner's December 10, 2020 SZQ Gallery painting beside the existing 2018 work above the garment rack. The pair spans 1.04 m, centered on the rack, with a 12 cm clear gap and common 2.35 m center height. Preserve the original calendar painting's frame and orientation. The new canvas is an estimated 30 × 40 × 2 cm, with its original white edge, heart, paint texture, and handwritten date; no invented frame or glass. Source-preserving registration and restrained high-pass bump/displacement bring out the matte paint without changing its color composition. Reuse archivePose, RoomArchiveCaption, PALETTE.paperLight, and the existing material-hover interaction; pointer, keyboard, X, Escape, Overview, and responsive placement follow the existing artwork behavior. Asset provenance accompanies the two WebP textures.
