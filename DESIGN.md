...
The actual rendered office supplies the immediate SSR loading still and versioned social image. A failed 3D chunk keeps the still and an ordinary profile link. Scene geometry and source photographs are retained; six GLBs use lossless compression and the Banpo loader starts only after React commits.
