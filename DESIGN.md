...
The whole focused gold plaque opens the existing Short, matching its full-body hover; distant activation still frames the photo/plaque pair. The TV shows one persistent archive/slide composition before and after focus, with a compact year/date tree. Any personal book starts closed on its cover regardless of available pages. Move the Halo2 controller beside the Mac mini and frame open research pages closer without clipping the spread.
