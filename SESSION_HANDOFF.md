...
Next authorized work is NOT included in this release: the October 2017 Liquor Journal magazine must stand inside a shelf in the LEFT opening half of the whisky cabinet (not on the coffee table), come out closed first, then open through the supplied photographed excerpts. A single magnet-held print below the lecture should show the owner's Eat Drink & Be Merry photographs with nearby unboxed English copy. Source-preserving WebP derivatives and unfinished components are local work in progress. The proposal-video frame belongs on the amplifier and remains asset-gated until the owner supplies the edited video; no substitute image or fictional video may be published. CD rack/replacement, EQ, physical preset styling, permanent arrangements, deferred lecture sources and further actual-device performance work remain open in `docs/office-follow-up-2026-09-11.md`. Do not silently mark these complete or include unrelated untracked experiments in a release.
