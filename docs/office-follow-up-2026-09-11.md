...
- **Han River:** the 12 September pass adds a bounded mapped low-rise layer and corrects the reflection boundary. Landmark-specific facades, smaller roads and further greenery detail can still improve; do not claim a photogrammetric city or factory-accurate building heights. Preserve mapped bridges and performance budgets.
