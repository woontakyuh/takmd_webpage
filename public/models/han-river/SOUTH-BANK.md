...
- [south-bank.json](./south-bank.json): 996 building footprints/parts (950 mapped plus 46 traced from official plans), 50 simplified construction envelopes, 215 tree placements, and the southward SRTM ground extension. OSM-derived geometry is © OpenStreetMap contributors under [ODbL 1.0](https://www.openstreetmap.org/copyright).
...
## Maple Xi and Trinione completion — 14 September

`banpo-completion-plans.json` records 29 labeled Maple Xi blocks (101–114, 201–215) and 17 Trinione blocks (101–117). Their simplified concave footprint envelopes are hand-traced from [Maple Xi’s official plan](https://www.xi.co.kr/maple/view?cmsMenuSeq=19763) and [Seoul’s Trinione redevelopment site plan](https://cleanup.seoul.go.kr/cafe/mastr-cleanup-bsnsSumry/execute.do?cafeId=650900000071b08&div=posImage&stepSeCode=102). Plan-to-map control points match the residential parcel corners. Maple’s two differently proportioned plots use separate mappings, with two triangles on the western plot; the marketing diagram is not an orthophoto. Building locations and envelope dimensions remain approximate. All 46 centers fall inside their mapped parcels, and existing mapped buildings are unchanged.

Trinione’s block maxima come from the [official floor diagram](https://www.raemian.co.kr/upload/editor/image/images/000326/pc_sub_floorplan.jpg): 101–117 respectively 33, 35, 35, 32, 20, 32, 35, 26, 20, 34, 35, 33, 31, 21, 33, 25, 31. Lower wings are not individually stepped. Heights use 3.05m per level, not metric surveys. Maple uses the 35-floor project envelope as an explicit estimate, except block 114’s documented 20 floors; individual Maple tower heights are not verified. Ancillary low-rise facilities are not exhaustively reconstructed. These additions complete the two apartment-block inventories, not an as-built architectural survey.
