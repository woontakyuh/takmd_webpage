...
const scenarios = [
  ...
  { name: 'authoring viewer path blocked', expected: 1, file: 'asset-viewer.html', content: '<main>Asset preview</main>' },
  { name: 'renamed authoring viewer blocked', expected: 1, file: 'preview.html', content: '<model-viewer src="/models/spine.glb"></model-viewer>' },
  { name: 'authoring marker blocked', expected: 1, file: 'preview.html', content: '<html data-authoring-only>' },
  { name: 'external authoring loader blocked', expected: 1, file: 'preview.js', content: 'import "https://ajax.googleapis.com/ajax/libs/model-viewer/3.5.0/model-viewer.min.js"' },
